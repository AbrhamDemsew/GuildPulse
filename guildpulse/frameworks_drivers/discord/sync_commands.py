...
Usage (development with guild-specific commands):
    python -m guildpulse.frameworks_drivers.discord.sync_commands

Usage (production with global commands):
    DISCORD_SYNC_GLOBAL=true python -m guildpulse.frameworks_drivers.discord.sync_commands
"""
...
from guildpulse.frameworks_drivers.discord.bot import setup_discord_bot
